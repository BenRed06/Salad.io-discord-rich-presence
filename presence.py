...
RPC.update(details="🔪 Currently Chopping", state="😀 Referal code: 5H9AJ2",  large_image='image', small_image='discord.png', large_text='SALAD.IO', small_text='text here', start=time.time())
